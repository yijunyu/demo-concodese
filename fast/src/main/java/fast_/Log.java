...
public final class Log extends Table {
  ...
  public fast_.Log_.Commit commit(int j) { return commit(new fast_.Log_.Commit(), j); }
  public fast_.Log_.Commit commit(fast_.Log_.Commit obj, int j) { int o = __offset(4); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int commitLength() { int o = __offset(4); return o != 0 ? __vector_len(o) : 0; }
  public fast_.Log_.Author author(int j) { return author(new fast_.Log_.Author(), j); }
  public fast_.Log_.Author author(fast_.Log_.Author obj, int j) { int o = __offset(6); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }

...
public final class Slice extends Table {
  ...
  public fast_.Slices_.Slice_.SourceFile file(int j) { return file(new fast_.Slices_.Slice_.SourceFile(), j); }
  public fast_.Slices_.Slice_.SourceFile file(fast_.Slices_.Slice_.SourceFile obj, int j) { int o = __offset(4); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }

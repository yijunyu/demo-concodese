...
public final class Bugs extends Table {
  ...
  public ByteBuffer repositoryInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 4, 1); }
  public fast_.Bugs_.Bug bug(int j) { return bug(new fast_.Bugs_.Bug(), j); }
  public fast_.Bugs_.Bug bug(fast_.Bugs_.Bug obj, int j) { int o = __offset(6); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }

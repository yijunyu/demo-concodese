...
package fast_.Slices_.Slice_.SourceFile_.Function_;
...
public final class Variable extends Table {
  ...
  public fast_.Slices_.Slice_.SourceFile_.Function_.Variable_.Position pos() { return pos(new fast_.Slices_.Slice_.SourceFile_.Function_.Variable_.Position()); }
  public fast_.Slices_.Slice_.SourceFile_.Function_.Variable_.Position pos(fast_.Slices_.Slice_.SourceFile_.Function_.Variable_.Position obj) { int o = __offset(6); return o != 0 ? obj.__assign(__indirect(o + bb_pos), bb) : null; }
  public int type() { int o = __offset(8); return o != 0 ? bb.getInt(o + bb_pos) : 0; }
  public fast_.Slices_.Slice_.SourceFile_.Function_.Variable_.Position defn(int j) { return defn(new fast_.Slices_.Slice_.SourceFile_.Function_.Variable_.Position(), j); }
  public fast_.Slices_.Slice_.SourceFile_.Function_.Variable_.Position defn(fast_.Slices_.Slice_.SourceFile_.Function_.Variable_.Position obj, int j) { int o = __offset(10); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int defnLength() { int o = __offset(10); return o != 0 ? __vector_len(o) : 0; }
  public fast_.Slices_.Slice_.SourceFile_.Function_.Variable_.Position use(int j) { return use(new fast_.Slices_.Slice_.SourceFile_.Function_.Variable_.Position(), j); }
  public fast_.Slices_.Slice_.SourceFile_.Function_.Variable_.Position use(fast_.Slices_.Slice_.SourceFile_.Function_.Variable_.Position obj, int j) { int o = __offset(12); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  ...
  public fast_.Slices_.Slice_.SourceFile_.Function_.Variable_.FunctionDecl cfunc(int j) { return cfunc(new fast_.Slices_.Slice_.SourceFile_.Function_.Variable_.FunctionDecl(), j); }
  public fast_.Slices_.Slice_.SourceFile_.Function_.Variable_.FunctionDecl cfunc(fast_.Slices_.Slice_.SourceFile_.Function_.Variable_.FunctionDecl obj, int j) { int o = __offset(18); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }

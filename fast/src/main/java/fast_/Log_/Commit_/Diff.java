...
public final class Diff extends Table {
  ...
  public ByteBuffer isCodeInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 10, 1); }
  ...
  public ByteBuffer indexFromInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 12, 1); }
  ...
  public ByteBuffer indexToInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 14, 1); }
  ...
  public ByteBuffer modeInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 16, 1); }
  public fast_.Log_.Commit_.Diff_.Hunk hunk(int j) { return hunk(new fast_.Log_.Commit_.Diff_.Hunk(), j); }
  public fast_.Log_.Commit_.Diff_.Hunk hunk(fast_.Log_.Commit_.Diff_.Hunk obj, int j) { int o = __offset(18); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }

...
public final class Delta extends Table {
  ...
  public ByteBuffer dstInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 6, 1); }
  public fast_.Delta_.Diff diff(int j) { return diff(new fast_.Delta_.Diff(), j); }
  public fast_.Delta_.Diff diff(fast_.Delta_.Diff obj, int j) { int o = __offset(8); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }

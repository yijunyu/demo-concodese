...
public final class Bug extends Table {
  ...
  public ByteBuffer opendateInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 6, 1); }
  ...
  public ByteBuffer fixdateInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 8, 1); }
  public fast_.Bugs_.Bug_.Info buginfo() { return buginfo(new fast_.Bugs_.Bug_.Info()); }
  public fast_.Bugs_.Bug_.Info buginfo(fast_.Bugs_.Bug_.Info obj) { int o = __offset(10); return o != 0 ? obj.__assign(__indirect(o + bb_pos), bb) : null; }
